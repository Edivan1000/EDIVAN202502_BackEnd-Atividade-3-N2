...
public class Produto {
	...
	private String modalidade; // Token , Cartão , Arquivo …

	// Muitos produtos estão associados a uma mesma categoria de certificado
	...
	// Construtor completo
	public Produto(Long codigo, String nome, String descricao, int validadeMeses, double preco, boolean disponivel,
			int quantidade, String tipoPessoa, String modalidade, CategoriaCertificado categoriaCertificado) {
		super();
		this.codigo = codigo;
		this.nome = nome;
